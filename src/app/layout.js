      ...
      <body className="antialiased min-h-screen bg-white dark:bg-slate-900 text-slate-900 dark:text-white flex flex-col">
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1357847906231140&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {/* End Meta Pixel Code */}
            ...
            __html: `
              if (typeof window !== 'undefined') {
                document.addEventListener('click', function(e) {
                  // Track Meta Pixel Lead event for any CTA/WA/Sleekflow widget click
                  const isLeadCta = e.target.closest('a[href="#live-chat"], a[href*="wa.me"], a[href*="api.whatsapp.com"], sleekflow-widget, [id*="sleekflow"], [class*="sleekflow"]');
                  if (isLeadCta) {
                    if (window.fbq) {
