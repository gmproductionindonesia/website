  ...
  const testimonials = [
    {
      ...
      image: "/images/rira.png"
    },
    {
      name: "Nia",
      role: "Business Development",
      quote: "Berkarya di sini memberikan ruang untuk eksplorasi, merubah kendala menjadi solusi yang inovatif. Bukan sekedar mencapai target, tapi juga memberikan dampak positif untuk tim dan pelanggan.",
      image: "/images/nia.png"
    },
    {
      name: "Bramsky",
      role: "Marcom Specialist",
    ...
    <section className="py-24 bg-zinc-900 relative border-t border-white/5">
      <div className="container mx-auto px-6 md:px-12 lg:px-16">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Cerita dibalik <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400">kesuksesan Event</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
