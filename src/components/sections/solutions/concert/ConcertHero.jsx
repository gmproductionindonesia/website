        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-5xl font-black text-white leading-[1.15] mb-8 tracking-tight">
              Bukan Sekedar Konser & Entertainment, Namun Pengalaman yang Lebih <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#c29b62] to-[#c29b62]">Immersive dan Berkesan</span>
            </h1>
            ...
            <Link 
              href="#live-chat"
              className="inline-flex items-center justify-center gap-3 bg-[#c29b62] hover:bg-[#a88654] text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 shadow-xl shadow-orange-900/20 hover:-translate-y-1 group"
            >
              Konsultasi Sekarang
