...
export default function ConcertWhy() {
  const reasons = [
    {
      icon: <Music className="text-[#c29b62] mb-6" size={32} />,
    ...
    {
      icon: <Activity className="text-[#c29b62] mb-6" size={32} />,
    ...
    {
      icon: <Mic2 className="text-[#c29b62] mb-6" size={32} />,
    ...
    {
      icon: <ShieldAlert className="text-[#c29b62] mb-6" size={32} />,
