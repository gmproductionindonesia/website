        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {deliverables.map((item, idx) => (
            <motion.div
              ...
              className="p-8 md:p-10 bg-slate-50 border border-slate-100 rounded-3xl hover:bg-white hover:border-orange-200 hover:shadow-xl hover:shadow-[#c29b62]/5 transition-all duration-300 group"
            >
              <div className="w-8 h-1.5 rounded-full bg-slate-200 mb-8 group-hover:bg-[#c29b62] group-hover:w-16 transition-all duration-300"></div>
