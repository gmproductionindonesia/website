...
export default function ExhibitionHero() {
  return (
    <section className="relative min-h-[90vh] flex items-center pt-24 pb-20 overflow-hidden">
      {/* Background Image with bright, modern overlay */}
      <div 
          ...
          >
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="text-orange-600 font-black tracking-[0.2em] uppercase text-sm">
                Exhibition & Brand Activation Solutions
              </span>
            </div>

            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-slate-900 leading-tight mb-8 tracking-tight">
              Solusi Exhibition & Brand Activation untuk Menciptakan <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">Pengalaman Brand yang Lebih Interaktif dan Menarik</span>
            </h1>
