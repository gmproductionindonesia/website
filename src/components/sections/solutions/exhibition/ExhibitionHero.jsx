        ...
        <div className="max-w-3xl">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-5xl font-black text-white leading-[1.15] mb-8 tracking-tight">
              Exhibition & Brand Activation untuk Menciptakan <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#c29b62] to-[#a88654]">Pengalaman Brand yang Lebih Kuat</span>
            </h1>
