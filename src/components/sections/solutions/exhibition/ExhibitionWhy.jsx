...
export default function ExhibitionWhy() {
  const reasons = [
    {
      icon: <Hammer className="text-orange-500 mb-6" size={32} />,
    ...
    {
      icon: <Move3d className="text-orange-500 mb-6" size={32} />,
    ...
    {
      icon: <Sparkles className="text-orange-500 mb-6" size={32} />,
    ...
    {
      icon: <Users className="text-orange-500 mb-6" size={32} />,
