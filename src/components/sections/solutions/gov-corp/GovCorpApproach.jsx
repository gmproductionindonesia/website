          ...
          {steps.map((step, idx) => (
            <motion.div
              ...
              className={`bg-white rounded-2xl p-8 border ${
                idx === 2 ? 'border-orange-400 shadow-xl shadow-orange-500/10 scale-105 z-10' : 'border-slate-200 shadow-lg shadow-slate-200/50'
              } hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 relative`}
            >
              <h3 className="text-4xl font-black text-orange-400 mb-4 tracking-tighter">
                {step.num}
              </h3>
