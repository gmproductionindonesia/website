...
export default function MultimediaStats() {
  const stats = [
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16 max-w-7xl">
        <div className="text-center mb-16 max-w-4xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 tracking-tight leading-tight">
            Dipercaya Mendukung Berbagai Event Berskala Nasional
          </h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 bg-white rounded-3xl overflow-hidden border border-slate-200 divide-y lg:divide-y-0 lg:divide-x divide-slate-200 shadow-xl shadow-slate-200/40">
          {stats.map((stat, idx) => (
            <motion.div
              key={idx}
