        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-orange-500 transition-colors text-white">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="#" className="hover:text-orange-500 transition-colors">Corporate Event</Link></li>
              <li><Link href="#" className="hover:text-orange-500 transition-colors">Concert & Entertainment</Link></li>
              <li><Link href="#" className="hover:text-orange-500 transition-colors">Exhibition & Activation</Link></li>
              <li><Link href="#" className="hover:text-orange-500 transition-colors">Multimedia & Equipment Solutions</Link></li>
              <li><Link href="#" className="hover:text-orange-500 transition-colors">Virtual & Hybrid Event</Link></li>
            </ul>
          </div>
